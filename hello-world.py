...
def decimal_to_binary():
    try:
        ...
        output_label.config(text="invalid input. please enter a decimal")
...
def binary_to_decimal():
    try:
        ...
        output_label.config(text="invalid input. plese enter a valid a binary number")
...
output_label = tk.Label(root, text="", pady=30)
output_label.pack()
